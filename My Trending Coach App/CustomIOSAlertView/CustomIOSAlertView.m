...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:37/255.0 green:50/255.0 blue:122/255.0 alpha:1.0] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:37/255.0 green:50/255.0 blue:122/255.0 alpha:1.0] forState:UIControlStateHighlighted];
        //closeButton.backgroundColor = [UIColor colorWithRed:37/255.0 green:50/255.0 blue:122/255.0 alpha:1.0];
